...
dimensions <- data.frame(Description = c("Number of Floors",
                         ...
                         Value = c(paste0(arch$nfloors.Q2[i]),
                                  paste0(arch$floorarea.Q2[i]),
                                  paste0(arch$roofareaplan.Q2[i]),
                                  paste0(arch$roofareaslope.Q2[i]),
                                  paste0(arch$ceilingground.Q2[i])),
                         Descriptions = c("External Wall Area (m2)", 
                                   "Internal Wall Area (m2)", 
                                   "DPC Perimeter (m)", 
                                   "Estimated Useful Solar Area (m2)",
                                   "First Floor Ceiling Height (m)"), 
                         Values = c(paste0(arch$extwallarea.Q2[i]),
                                  paste0(arch$intwallarea.Q2[i]),
                                  paste0(arch$dpcperim.Q2[i]),
                                  paste0(arch$solararea.Q2[i]),
                                  paste0(arch$ceilingfirst.Q2[i])) )

#Make doors and windows table
windows <- data.frame(Description = c("Number of Windows", "Number of External Doors"), 
                         Value = c(paste0(arch$windows.Q2[i]),
                                   paste0(arch$doors.Q2[i])),
                         Descriptions = c("Window Area (m2)", 
                                   ""), 
                         Values = c(paste0(arch$extwindowarea.Q2[i]),
                                  ""))
...
summary <- data.frame(Description = c("Built between",
                      ...
                      Value = c(paste0(arch$age.Q2[i]),
                                paste0(arch$sap.Q2[i]),
                                ""
                                ),
                      ...
                      Values = c(paste0(arch$control.Q2[i]),
                                 paste0(arch$radcontrol.Q2[i]),
                                 arch$gasgrid.yes[i]
                                 )
...
Dwellings of this archetype have the following typical existing characteristics. Values show the median (middle value) for this archetype.
