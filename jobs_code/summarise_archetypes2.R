...
comb$extwallarea <- comb$dpc.perim * comb$cheight0 * comb$storeyx
...
arch = comb %>%
        group_by(archcode) %>%
          summarise(
                    ...
                    extwallarea.Q1 =     wtd.quantile(wall.area.ext,   aagpd1213, probs = 0.25),
                    extwallarea.Q2 =     wtd.quantile(wall.area.ext,   aagpd1213, probs = 0.50),
                    extwallarea.Q3 =     wtd.quantile(wall.area.ext,   aagpd1213, probs = 0.75),
                    ...
                    #Other Dimensions
                    extwindowarea.Q1 =   wtd.quantile(window.area.ext, aagpd1213, probs = 0.25),
                    extwindowarea.Q2 =   wtd.quantile(window.area.ext, aagpd1213, probs = 0.50),
                    extwindowarea.Q3 =   wtd.quantile(window.area.ext, aagpd1213, probs = 0.75),
                    ...
                    nfloors.Q1 =         wtd.quantile(NFlorm,          aagpd1213, probs = 0.25),
                    nfloors.Q2 =         wtd.quantile(NFlorm,          aagpd1213, probs = 0.50),
                    nfloors.Q3 =         wtd.quantile(NFlorm,          aagpd1213, probs = 0.75),
                    ...
                    tank.wellins =       round(sum(aagpd1213[tankins == "Well Insulated"])/sum(aagpd1213)*100,1),
                    wallins =            round(sum(aagpd1213[wallinsy %in% c("cavity with insulation","solid with insulation")])/sum(aagpd1213)*100,1),
                    loftins =            round(sum(aagpd1213[LoftIns  %in% c("cavity with insulation","solid with insulation")])/sum(aagpd1213)*100,1),
                    # Locations
