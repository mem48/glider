...
names(general) <- c("aacode","aagpd1011","tenure4x","GorEHCS","imd")
...
#Context Table
###########################################################################
context <- combined[c("aacode","aagpd1011","tenure4x","GorEHCS","imd","arnatx")]
...
test <- combined_2011[,c("aacode","aagpd1011","Finchtyp","mainfuel","watersys","tank")]
